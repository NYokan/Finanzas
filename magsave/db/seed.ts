...
// del componente en phosphor-react-native.
const DEFAULT_CATEGORIES: NewCategory[] = [
  ...
  { name: 'Ocio', icon: 'FilmSlate', color: '#F39C12', type: 'expense', isDefault: 1 },
  { name: 'Ropa', icon: 'TShirt', color: '#E91E63', type: 'expense', isDefault: 1 },
